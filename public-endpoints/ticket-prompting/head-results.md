...
Run on 2026-08-28T01:16:03Z, from OpenSSL 3.6.3 9 Jun 2026 (Library: OpenSSL 3.6.3 9 Jun 2026), against the 14 hosts in `panel.txt` (sha256 `f05931e024c211d5`). Two connections per host: one to mint a session ticket, one to offer it back to the same address and the same SNI.
...
- 12 resumed a connection that offered that ticket back.
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| aws.amazon.com | 13.32.121.33 | TLSv1.3 | X25519MLKEM768 | yes | 3 | 3916 | yes | 56146 | no | - | 0 |
| docs.aws.amazon.com | 13.35.58.2 | TLSv1.3 | X25519MLKEM768 | yes | 3 | 3778 | yes | 77738 | yes | tls13_psk | 0 |
| cloud.google.com | 142.251.168.100 | TLSv1.3 | X25519MLKEM768 | yes | 3 | 4812 | yes | 172800 | yes | tls13_psk | 0 |
...
| google.com | 172.253.157.100 | TLSv1.3 | X25519MLKEM768 | yes | 3 | 4812 | yes | 172800 | yes | tls13_psk | 0 |
...
session ticket                      : yes, seen via post_handshake_newsessionticket, lifetime hint 56146
resumed on second connection        : no
verify on the resumed connection    : 0 (ok)
peername reverified on resumption   : aws.amazon.com
```
...
first connection verify             : 0 (ok)
session ticket                      : yes, seen via post_handshake_newsessionticket, lifetime hint 77738
